...
CREATE TABLE "UsersResult" (
    ...
    CONSTRAINT "UsersResult_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UsersResult" ADD CONSTRAINT "UsersResult_userid_fkey" FOREIGN KEY ("userid") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
