...
export type RoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"value" | "description", ExtArgs["result"]["role"]>
...
export interface RoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const roleWithValueOnly = await prisma.role.findMany({ select: { value: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Roles and only return the `value`
   * const roleWithValueOnly = await prisma.role.createManyAndReturn({
   *   select: { value: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Roles and only return the `value`
   * const roleWithValueOnly = await prisma.role.updateManyAndReturn({
   *   select: { value: true },
   *   where: {
   *     // ... provide filter here
   *   },
